             ...
             <div className=" w-full ">
              <table className="table">
                ...
                <tbody className=' text-sm'>
                  ...
                  {
                    cooks.map( (item, index) => <tr  key={index}>
                    <th>{index+1}</th>
                    ...
                    onClick={() => handleCooking(item)}
                     className="btn btn-primary mx-2 my-2 rounded-full bg-green-400 text-black border-none text-[16px] font-normal ">Preparing</button></td>
                  </tr> )
                  }
             ...
             <div className=" w-full ">
              <table className="table">
                ...
                <tbody className=' text-sm'>
                  ...
                  {
                    cooking.map( (item, index) => <tr  key={index}>
                    <th>{index+1}</th>
                    <td>{item.recipe_name}</td>
                    <td>{item.preparing_time}</td>
                    <td>{item.calories}</td>
